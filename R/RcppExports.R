...
EL_eval <- function(g, maxit, abstol, threshold) {
    .Call(`_elgbd_EL_eval`, g, maxit, abstol, threshold)
}

WEL_eval <- function(g, w, maxit, abstol, threshold) {
    .Call(`_elgbd_WEL_eval`, g, w, maxit, abstol, threshold)
}
...
EL_confint2 <- function(x, type, par0, cutoff, maxit, abstol, threshold) {
    .Call(`_elgbd_EL_confint2`, x, type, par0, cutoff, maxit, abstol, threshold)
}
